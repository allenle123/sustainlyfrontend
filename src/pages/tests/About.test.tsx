...
describe('About Component', () => {
  ...
  it('contains information about product analysis factors', () => {
    const analysisInfo = screen.getByText(/We analyze products across multiple sustainability factors/i);
    expect(analysisInfo).toBeInTheDocument();
  });

  it('has the correct intro paragraph', () => {
    const introParagraph = screen.getByText(/Sustainly helps you make more environmentally conscious/i);
